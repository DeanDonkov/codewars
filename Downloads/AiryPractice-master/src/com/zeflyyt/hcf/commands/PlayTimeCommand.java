...
import com.zeflyyt.hcf.BaseCommand;
import com.zeflyyt.hcf.BaseConstants;
...
public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
  {
    ...
    sender.sendMessage(ChatColor.DARK_AQUA + target.getName() + " §bplaytime is " + ChatColor.WHITE + DurationFormatUtils.formatDurationWords(this.plugin.getPlayTimeManager().getTotalPlayTime(target.getUniqueId()), true, true) + ChatColor.AQUA + " this map.");
    return true;
  }

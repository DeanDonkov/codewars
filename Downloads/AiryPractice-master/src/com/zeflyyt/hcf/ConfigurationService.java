...
//	public static final boolean GET_POTS_FREE = Base.getPlugin().config.getBoolean("get_pots_free");
	public static final boolean FOOTER = Base.getPlugin().getConfig().getBoolean("Footer.Permit");
	...
	public static final Map<Environment, Double> SPAWN_RADIUS_MAP = new EnumMap<Environment, Double>(
			Environment.class);
	...
	static {
		...
		SPAWN_RADIUS_MAP.put(Environment.NORMAL, Double.valueOf(0.0D));
		SPAWN_RADIUS_MAP.put(Environment.NETHER, Double.valueOf(0.0D));
		SPAWN_RADIUS_MAP.put(Environment.THE_END, Double.valueOf(0.0D));
	}

    ...
    public void onCreatureSpawn(CreatureSpawnEvent event){ 
        if(shouldClear()){
            for(Entity entity : plugin.getServer().getWorlds().get(0).getEntities()){
                if(entity instanceof Player || entity instanceof Projectile || entity instanceof ItemFrame || entity instanceof Pig || entity instanceof Minecart || entity instanceof Chicken){
                    continue;
                }

...
public class WeekendSaleListener implements Listener {
    ...
    public static class RebootRunnable extends BukkitRunnable {
        ...
        private WeekendSaleListener rebootTimer;
        private long startMillis;
        private static long endMillis;

        @SuppressWarnings("static-access")
		public RebootRunnable(WeekendSaleListener rebootTimer, long duration) {
